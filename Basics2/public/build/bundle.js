...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file, 14, 2, 268);
    			add_location(button1, file, 15, 2, 321);
    			add_location(article, file, 12, 0, 228);
    		},
    ...
    class Product extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { productTitle: 0 });
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	const add_to_cart_handler = () => alert("add to cart");
    	const delete_handler = () => alert("delete");
