...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 35, 0, 630);
    			attr_dev(header, "class", "svelte-b5ju1u");
    			add_location(header, file$1, 38, 2, 717);

    			if (!footer_slot) {
    				attr_dev(button, "type", "button");
    				add_location(button, file$1, 44, 6, 824);
    			}

    			add_location(footer, file$1, 42, 2, 782);
    			attr_dev(div1, "class", "modal svelte-b5ju1u");
    			add_location(div1, file$1, 37, 0, 694);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!footer_slot) {
    				...
    				dispose_footer_slot = listen_dev(button, "click", /*click_handler_1*/ ctx[4], false, false, false);
    			}
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(41:2) {#each products as product}",
    		ctx
    	});
    ...
    function create_header_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 62, 6, 1145);
    		},
    		m: function mount(target, anchor) {
    ...
    // (66:6) <button         slot="footer"         on:click={() => {           showModal = false;         }}         type="button">
    function create_footer_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "type", "button");
    			add_location(button, file$2, 65, 6, 1266);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(66:6) <button         slot=\\\"footer\\\"         on:click={() => {           showModal = false;         }}         type=\\\"button\\\">",
    		ctx
    	});
    ...
    // (56:4) <Modal       on:close={() => {         showModal = false;       }}       on:cancel={() => {         showModal = false;       }}>
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			add_location(p, file$2, 63, 6, 1186);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, t0, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(56:4) <Modal       on:close={() => {         showModal = false;       }}       on:cancel={() => {         showModal = false;       }}>",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			if (if_block) if_block.c();
    			add_location(button, file$2, 47, 2, 895);
    			add_location(main, file$2, 29, 0, 436);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
