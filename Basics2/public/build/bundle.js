    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 37, 0, 655);
    			attr_dev(header, "class", "svelte-b5ju1u");
    			add_location(header, file$1, 40, 2, 742);
    			add_location(p, file$1, 45, 4, 837);
    			add_location(button0, file$1, 46, 4, 899);
    			attr_dev(div1, "class", "disclaimer");
    			add_location(div1, file$1, 44, 2, 807);

    			if (!footer_slot) {
    				attr_dev(button1, "type", "button");
    				button1.disabled = button1_disabled_value = !/*agreed*/ ctx[0];
    				add_location(button1, file$1, 50, 6, 1028);
    			}

    			add_location(footer, file$1, 48, 2, 968);
    			attr_dev(div2, "class", "modal svelte-b5ju1u");
    			add_location(div2, file$1, 39, 0, 719);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!footer_slot) {
    				...
    				dispose_footer_slot = listen_dev(button1, "click", /*click_handler_2*/ ctx[6], false, false, false);
    			}
    		...
    		p: function update(ctx, [dirty]) {
    			if (header_slot && header_slot.p && dirty & /*$$scope*/ 4) {
    				header_slot.p(get_slot_context(header_slot_template, ctx, /*$$scope*/ ctx[2], get_header_slot_context), get_slot_changes(header_slot_template, /*$$scope*/ ctx[2], dirty, get_header_slot_changes));
    			}
    			...
    			if (footer_slot && footer_slot.p && dirty & /*$$scope, agreed*/ 5) {
