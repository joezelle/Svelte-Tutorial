...
var app = (function () {
    ...
    // (63:2) <Button mode="outline" on:click={displayDescription}>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(63:2) <Button mode=\\\"outline\\\" on:click={displayDescription}>",
    		ctx
    	});
    ...
    // (66:2) <Button on:click={removeFromCart}>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(66:2) <Button on:click={removeFromCart}>",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$1, 67, 4, 1458);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(67:2) {#if showDescription}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 60, 2, 1200);
    			attr_dev(h2, "class", "svelte-1td7xux");
    			add_location(h2, file$1, 61, 2, 1219);
    			attr_dev(li, "class", "svelte-1td7xux");
    			add_location(li, file$1, 59, 0, 1193);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 51, 6, 968);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    // (49:4) {#each $customCart as item (item.id)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$customCart*/ 1) cartitem_changes.id = /*item*/ ctx[3].id;
    			if (dirty & /*$customCart*/ 1) cartitem_changes.title = /*item*/ ctx[3].title;
    			if (dirty & /*$customCart*/ 1) cartitem_changes.price = /*item*/ ctx[3].price;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(49:4) {#each $customCart as item (item.id)}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	let current;
    	let each_value = /*$customCart*/ ctx[0];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 46, 2, 817);
    			attr_dev(ul, "class", "svelte-1c2znv1");
    			add_location(ul, file$2, 47, 2, 833);
    			attr_dev(section, "class", "svelte-1c2znv1");
    			add_location(section, file$2, 45, 0, 805);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*$customCart*/ 1) {
    				const each_value = /*$customCart*/ ctx[0];
    				validate_each_argument(each_value);
    				group_outros();
    				validate_each_keys(ctx, each_value, get_each_context, get_key);
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	let $customCart;
    	validate_store(customCart, "customCart");
    	component_subscribe($$self, customCart, $$value => $$invalidate(0, $customCart = $$value));
    	let items;
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 45, 4, 752);
    			attr_dev(h2, "class", "svelte-9ht2za");
    			add_location(h2, file$3, 46, 4, 773);
    			attr_dev(p, "class", "svelte-9ht2za");
    			add_location(p, file$3, 47, 4, 794);
    			add_location(div0, file$3, 44, 2, 742);
    			add_location(div1, file$3, 49, 2, 826);
    			attr_dev(div2, "class", "product svelte-9ht2za");
    			add_location(div2, file$3, 43, 0, 718);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 29, 2, 510);
    			attr_dev(section, "class", "svelte-o8blwk");
    			add_location(section, file$4, 28, 0, 498);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (15:0) <Button   on:click={() => {     showCart = !showCart;   }}>
    function create_default_slot$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(15:0) <Button   on:click={() => {     showCart = !showCart;   }}>",
    		ctx
    	});
